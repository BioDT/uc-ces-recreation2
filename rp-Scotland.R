...
#Score_column <- args[1]
Score_column <- "SR"  ### couldn't get the args to work so used old version to select score column ###
...
# output boundaries
target_shapefile <- "/data/notebooks/rstudio-rp2r/testp/RP_Scotland/input/boundaries.shp"  ### added filepath to work ###
# empty raster name
empty_raster <- "/data/notebooks/rstudio-rp2r/testp/RP_Scotland/input/empty.tif"  ### added filepath to work ###
