...
faq_html <- tags$div(
    ...
    tags$p("If you cannot find the answer to your question here, please reach out to",
    ...
    tags$p("The recreation potential model is part of the BioDT project. More information on this project can be found",
    ...
    tags$p("A digital twin is a virtual representation of real-world entities and processes, synchronized at a specified frequency and fidelity.",
           tags$br(),
           "You can learn more",
           " ", tags$a(href = "https://biodt.eu/DigitalTwin", target = "_blank", "here"),"."),
    
    tags$h4("3. Where can I find academic literature on this model?"),
    tags$p("Rolph S, Andrews C, Carbone D, Lopez Gordillo J, Martinovič T, Oostervink N, Pleiter D, Sara-aho K, Watkins J, Wohner C, Bolton W, Dick J (2024) Prototype Digital Twin: Recreation and biodiversity cultural ecosystem services. Research Ideas and Outcomes 10: e125450.",
    ...
    tags$p("The recreation potential (RP) model uses external data sources capturing information about the physical (natural and built) environment.  It is divided into four categories:",
           tags$br(),
    ...
    tags$p("The Recreational Potential is scaled to a range of 0-1. Where 0 represents almost no RP value to the user and 1 is the highest possible value. This is scaled specifically to the area chosen only and is not representative as Scotland as a whole."),
    
    tags$h4("6. Why did you select 87 variables to parameterise the recreational potential model?"),
    tags$p("We read the literature on what aspects of nature people found attractive and attempted to find free (open source) national or international datasets which we could use to characterise Scotland.  We grouped some of the features like slope, into categories.",
           tags$br(),
    ...
    tags$p("We have not yet been able to provide the biodiversity data for the whole of Scotland but you can see the combined models",
    ...
    tags$p("We use data provided by citizen science projects. We use the data from GBIF—",
