...
Boundary_name <- "Bush" ### short descriptive name of boundary region to be included in output names

# input directory
input_folder <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/input"  ### added filepath to work ###

# output directory
output_folder <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/output"  ### added filepath to work ###

# Set the location of the raw shapefiles
Raw_Shapefile <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/input/Raw_Shapefile/"
...
raster_folder <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/input/SLSRA"  ### added filepath to work ###
...
# Set the folder paths here
raster_folder <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/input/FIPS_N" ### added filepath to work ###
...
# firstly reclassify the un-scored rasters with the correct score using the function: FUNC_Raster_Reclassifier
# Set the folder paths here
raster_folder <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/input/FIPS_I"
...
# firstly reclassify the un-scored rasters with the correct score using the function: FUNC_Raster_Reclassifier
# Set the folder paths here
raster_folder <- "/data/notebooks/rstudio-rp2r/testp/R_ShinyVersion/input/Water"   ### added filepath to work ###
