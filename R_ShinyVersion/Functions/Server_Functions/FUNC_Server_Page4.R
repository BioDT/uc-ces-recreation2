...
server_page4 <- function(input, output, session) {
  ...
  fips_i_questions <- list(
    ...
    FIPS_I_NFERR = paste0("FIPS_I_NFERR_", 1:10),
    FIPS_I_NFERA = paste0("FIPS_I_NFERA_", 1:17),
    FIPS_I_LocalPathNetwork = c("FIPS_I_LocalPathNetwork_1", "FIPS_I_LocalPathNetwork_2")
  )
