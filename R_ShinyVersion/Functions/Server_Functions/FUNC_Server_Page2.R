...
server_page2 <- function(input, output, session) {
  ...
  slsra_questions <- list(
    SLSRA_CP = c("SLSRA_CP_1", "SLSRA_CP_2"),
    SLSRA_HLUA = paste0("SLSRA_HLUA_", 1:24),
    SLSRA_HNV = c("SLSRA_HNV_1", "SLSRA_HNV_2"),
    SLSRA_LCM = paste0("SLSRA_LCM_", 1:28),
    SLSRA_NNR = c("SLSRA_NNR_1", "SLSRA_NNR_2"),
    SLSRA_NP = c("SLSRA_NP_1", "SLSRA_NP_2"),
    SLSRA_NR = c("SLSRA_NR_1", "SLSRA_NR_2"),
    SLSRA_RP = c("SLSRA_RP_1", "SLSRA_RP_2"),
    SLSRA_RSPB = c("SLSRA_RSPB_1", "SLSRA_RSPB_2"),
    SLSRA_SAC = c("SLSRA_SAC_1", "SLSRA_SAC_2"),
    SLSRA_SPA = c("SLSRA_SPA_1", "SLSRA_SPA_2"),
    SLSRA_SSSI = c("SLSRA_SSSI_1", "SLSRA_SSSI_2"),
    SLSRA_SWT = c("SLSRA_SWT_1", "SLSRA_SWT_2"),
    SLSRA_WLA = c("SLSRA_WLA_1", "SLSRA_WLA_2")
  )
