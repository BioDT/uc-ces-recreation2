  ...
  div(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        numericInput("FIPS_N_NFI_1", "Woodland: Assumed Woodland", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_2", "Woodland: Grass", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_3", "Woodland: Ground Prepared for Planting", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_4", "Woodland: Felled", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_5", "Woodland: Shrub Land", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_6", "Woodland: Young Trees", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_7", "Woodland: Mixed - predominantly Conifer", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_8", "Woodland: Broadleaved", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_9", "Woodland: Coppice", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_10", "Woodland: Low Density", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_11", "Woodland: Conifer", value = 0, min = 0, max = 10),
        numericInput("FIPS_N_NFI_12", "Woodland: Mixed - predominantly Broadleaved", value = 0, min = 0, max = 10),
