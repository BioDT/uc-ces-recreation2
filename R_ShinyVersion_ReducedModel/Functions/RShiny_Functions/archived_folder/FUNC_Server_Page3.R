...
server_page3 <- function(input, output, session) {
  ...
  file_paths <- list(
    FIPS_N_Landform = "/data/notebooks/rstudio-rpmodel/testp/R_ShinyVersion_ReducedModel/input/FIPS_N/FIPS_N_Landform.csv",
    FIPS_N_Soil = "/data/notebooks/rstudio-rpmodel/testp/R_ShinyVersion_ReducedModel/input/FIPS_N/FIPS_N_Soil.csv",
    FIPS_N_Slope = "/data/notebooks/rstudio-rpmodel/testp/R_ShinyVersion_ReducedModel/input/FIPS_N/slope/FIPS_N_Slope.csv"
  )
